...
app.getAccelerometerValues = function(data)
{
    ...
    window.ax = evothings.util.littleEndianToInt16(data, 6) / divisors.x;
    window.ay = evothings.util.littleEndianToInt16(data, 8) / divisors.y;
    window.az = evothings.util.littleEndianToInt16(data, 10) / divisors.z;
	// Return result.
